...
import CoinForm from "@/components/buy-sell-form/CoinForm";
import { ChevronRight, Landmark } from "lucide-react";
import { moneyParse } from "@/libs/numbering";
import Image from "next/image";
import styles from "@/components/buy-sell-form/form.module.css";
...
const ModalProvider: FC<ModalProviderProps> = ({ coins }) => {
  const { active, toggle } = useTradeModal();
                ...
                <ModalBody className="p-0 pt-4">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <Image
                        src={`/icon/${watch("coin_symbol").toLowerCase()}.png`}
                        alt={watch("coin_name")}
                        width={24}
                        height={24}
                        className="h-10 w-10"
